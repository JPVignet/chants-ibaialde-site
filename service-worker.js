...
// ⚠️ liste complète (225 chants + index + base)
const urlsToCache = [
  "./",
  "index.html",
  "style.css",
...
self.addEventListener("activate", event => {
  event.waitUntil(
    (async () => {
      ...
      // 🔥 prend immédiatement le contrôle de toutes les pages ouvertes
...
// ==========================
// FETCH : stratégie stable "cache first + fallback réseau"
// ==========================
